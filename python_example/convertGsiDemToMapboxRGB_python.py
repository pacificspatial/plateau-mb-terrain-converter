#################################################################################
#                            convertGsiDemToMapboxRGB_python.py
# 
# Python example of CreateGsiTileset() function.
#
# (c) 2025 MLIT Japan.
...
def pyConvertGsiDemToMapboxRGB(argv = sys.argv):
    ...
    feedback = myFeedback()
    CreateGsiTileset(args.input, args.outdir, args.min_zoom, args.max_zoom, args.overwrite, feedback)
